...
function FormPred() {
    ...
    const handleSubmitID3 = async (event) => {
    ...
    const handleSubmitJ48 = async (event) => {
        event.preventDefault();
        handleValidation();
    ...
    const handleSubmitBoth = async (event) => {
        event.preventDefault();
        handleValidation();
        ...
        <div className="wrapper">
            <form className='form' onSubmit={handleValidation}>
                ...
                <div className='formEle'>
                    ...
                    <input name='age' type="number" value={formData.age} onChange={handleChange} autoFocus required/>
                ...
                <div className='formEle'>
                    <label htmlFor="id_education_num">Education level:</label>
                ...
                {errors.capital_gain && <p className='text-red-500 text-xs'>{errors.capital_gain}</p>}
                </div>
                ...
                {errors.capital_loss && <p className='text-red-500 text-xs'>{errors.capital_loss}</p>}
                </div>
                ...
                {errors.hours_per_week && <p className='text-red-500 text-xs'>{errors.hours_per_week}</p>}
                </div>
                ...
                {/* <button className='btn' type='submit' onClick={handleSubmitID3}>Predict Using RF with ID3</button>

                <button className='btn' type='submit' onClick={handleSubmitJ48}>Predict Using RF with J48</button>

                <button className='btn' type='submit' onClick={handleSubmitBoth}>Predict Using Both</button> */}

                <div className='formEle'>
                    <label htmlFor="id_mode">Select Model:</label>
                    <select name="mode" required id="id_mode" value={formData.mode} onChange={handleChange} className='w-max'>

                        <option value="0">Predict Using RF with ID3</option>
                        <option value="1">Predict Using RF with J48</option>
                        <option value="2">Predict Using Both</option>
                    </select>
                </div>
            ...
            <div className="predict">
                <h1 className='text-4xl text-neutral-100'>Output</h1>
            {result && (
                <h1>{prediction[0] ? (
